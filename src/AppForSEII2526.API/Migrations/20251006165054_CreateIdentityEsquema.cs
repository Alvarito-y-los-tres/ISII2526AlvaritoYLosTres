        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumeroTelefono = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlquilerItems", x => x.IdAlquiler);
                    table.ForeignKey(
                        name: "FK_AlquilerItems_Alquileres_AlquilerId",
                        column: x => x.AlquilerId,
                        principalTable: "Alquileres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlquilerItems_Herramientas_HerramientaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioFinal = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlquilerItems_AlquilerId",
                table: "AlquilerItems",
                column: "AlquilerId");

            migrationBuilder.CreateIndex(
                name: "IX_AlquilerItems_HerramientaId",
                table: "AlquilerItems",
